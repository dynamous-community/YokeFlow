...
Resets a project back to the state immediately after initialization session.
This allows iteration on coding sessions and prompt improvements without
re-running the time-consuming initialization (10-20 minutes).

This module is designed for API integration and programmatic use.
For CLI usage, see reset_project.py.
